...
LOCALE_PATHS = [normpath(join(PROJECT_ROOT, "common", "locale"))]
...
IGNORABLE_404_URLS = (re.compile("/hm"),)
...
LOGGING = {
    ...
    "loggers": {
        ...
        "py.warnings": {"propagate": False, "handlers": ["null"]},
...
MEDIAMANAGER_URL = "http://media.delving.org"
